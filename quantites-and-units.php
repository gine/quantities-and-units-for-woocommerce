		...
		if ( !in_array( 'woocommerce-thumbnail-input-quantities/woocommerce-thumbnail-input-quantity.php', apply_filters( 'active_plugins', get_option( 'active_plugins' ) ) ) ) {
			...
			if ( ! get_user_meta( $user_id, 'wpbo_thumbnail_input_notice' ) ) {
				...
				echo '<div class="updated">'.
					__('<p><strong>Notice:</strong> It is highly recommended you install and activate the <a href="http://wordpress.org/plugins/woocommerce-thumbnail-input-quantities/" target="_blank">WooCommerce Thumbnail Input Quantites</a> plugin to display input boxes on products thumbnails.', 'qau')
					.' <a href="';
			    ...
			    echo '">'.__("Dismiss Notice",'qau').'</a></p></div>';
			}
		}
	}
